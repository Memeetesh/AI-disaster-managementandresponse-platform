...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col justify-center px-4 py-16">
      <h1 className="mb-1 text-xl font-bold text-white">Create a citizen account</h1>
      <p className="mb-6 text-sm text-slate-500">
        Responder/admin accounts are provisioned separately by a command-center admin.
      </p>
